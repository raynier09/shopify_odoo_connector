...
class SaleReport(models.Model):
    ...
    _description = "Shopify Sales Analysis Report"
    _auto = False
    _rec_name = 'date'
    _order = 'date desc'
    ...
    shopify_instance_id = fields.Many2one(comodel_name='shopify.instance', string="Shopify Instance", readonly=True)
    ...
    def _select_sale(self):
        select_ = f"""
            ...
            s.shopify_instance_id as shopify_instance_id, --Shopify Fields
            p.product_tmpl_id,
